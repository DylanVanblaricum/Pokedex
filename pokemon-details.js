...
function displayPokemonDetails(pokemon) {
    ...
    const imageElement2 = document.querySelector(".detail-img-wrapper2 img");
    imageElement2.src = `https://raw.githubusercontent.com/pokeapi/sprites/master/sprites/pokemon/other/showdown/${id}.gif`;
